            ...
            <div className="absolute top-0 right-0">
                ...
                <div className="grid gap-4 grid-cols-3">
                    ...
                    healthServices ? healthServices.map(healthCare => (
                        <div key={healthCare._id} className="card max-w-xs px-8 py-4 mx-auto bg-teal-400 rounded-lg shadow-md dark:bg-gray-800" style={{ cursor: "auto" }}>
                    <div className="flex items-center justify-between">
                        <div className="flex items-center">
                            ...
                            <button className="px-3 py-1 mx-3 text-sm font-bold text-gray-100 transition-colors duration-200 transform bg-gray-600 rounded cursor-pointer hover:bg-gray-500">{healthCare.alias}</button>
                        </div>
